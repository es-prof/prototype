...
#define BACKEND_CXX_COMPILER_MINOR_VERSION_NUMBER 2
...
#define CXX_INCLUDE_STRING {"g++_HEADERS", "g++_HEADERS/hdrs", "g++_HEADERS/hdrs1", "g++_HEADERS/hdrs2", "g++_HEADERS/hdrs5", "/usr/local/packages/gcc-4.2.0/lib/gcc/x86_64-unknown-linux-gnu/4.2.0/../../../../include/c++/4.2.0", "/usr/local/packages/gcc-4.2.0/lib/gcc/x86_64-unknown-linux-gnu/4.2.0/../../../../include/c++/4.2.0/x86_64-unknown-linux-gnu", "/usr/local/packages/gcc-4.2.0/lib/gcc/x86_64-unknown-linux-gnu/4.2.0/../../../../include/c++/4.2.0/backward", "/usr/local/include", "/usr/local/packages/gcc-4.2.0/include", "/usr/local/packages/gcc-4.2.0/lib/gcc/x86_64-unknown-linux-gnu/4.2.0/include",  "/usr/include"}
...
#define CXX_SPEC_DEF {"-D__GNUG__=4", "-D__GNUC__=4", "-D__GNUC_MINOR__=2", "-D__GNUC_PATCHLEVEL__=0", "--preinclude", "rose_edg_required_macros_and_functions.h"}

/* Include path for backend C compiler. */
#define C_INCLUDE_STRING {"gcc_HEADERS", "gcc_HEADERS/hdrs", "gcc_HEADERS/hdrs2", "/usr/local/include", "/usr/local/packages/gcc-4.2.0/include", "/usr/local/packages/gcc-4.2.0/lib/gcc/x86_64-unknown-linux-gnu/4.2.0/include",  "/usr/include"}
