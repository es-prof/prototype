...
#if !defined(USE_GENERIC_WALLCLOCK_TIMER)
typedef struct {
...
#if 0 // original code -- ertl-liyixiao
...
#if defined(USE_GENERIC_WALLCLOCK_TIMER)
  GPTLgeneric_wallclock_init();
  ptr2wtimefunc = GPTLgeneric_wallclock;
#else // original code -- ertl-liyixiao
...
/**********************************************************************************/
/* 
** A Threading Library Abstraction Layer
*/

#elif ( defined THREADED_CUSTOM )
