...
# C compiler
TOPPERS_POSIX_FLAGS = -mnewlib -D__toppers__ -I../git-fmp-mc/fmp/tile-sdk/common/library/newlib/newlib-1.13.0/newlib/libc/include -I../git-fmp-mc/fmp/tile-sdk/common/library/newlib/include
CC = tile-gcc $(TOPPERS_POSIX_FLAGS) -DUSE_GENERIC_WALLCLOCK_TIMER
...
ifeq ($(DEBUG),yes)
  ...
  #CFLAGS = -g -O1 -fno-inline -Winline -Wall
endif
